...
public class Farmer extends Actor
{
    ...
    public void farmerAnimation()
    {
        ...
        {
            GreenfootImage pickSheep_animation;
            GifImage farmer_Up =  GifImage("pickSheep-up.gif");
            GifImage farmer_Down =  GifImage("pickSheep-down.gif");
            GifImage farmer_Right =  GifImage("pickSheep-right.gif");
            GifImage farmer_Left =  GifImage("pickSheep-left.gif");
